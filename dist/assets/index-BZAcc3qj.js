(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&l(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();Vue.component("link-cascadia",{template:`
    ...
    `});Vue.component("panel-blog",{template:`
    ...
    `});new Vue({el:"#app",data:{theme:"light"},mounted(){this.theme=localStorage.theme??"system",this.applyTheme()},methods:{setDarkMode(){localStorage.theme="dark",document.getElementById("app").classList.add("dark"),this.theme="dark",this.applyTheme()},setLightMode(){localStorage.theme="light",document.getElementById("app").classList.remove("dark"),this.theme="light",this.applyTheme()},setSystemMode(){localStorage.removeItem("theme"),document.getElementById("app").classList.remove("dark"),this.theme="system",this.applyTheme()},applyTheme(){localStorage.theme==="dark"||!("theme"in localStorage)&&window.matchMedia("(prefers-color-scheme: dark)").matches?document.documentElement.classList.add("dark"):document.documentElement.classList.remove("dark")}}});
